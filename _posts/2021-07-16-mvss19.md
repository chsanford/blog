...
We let $$X \in \mathbb{R}^{n \times d}$$, $$Y \in \mathbb{R}^n$$, and $$W \in \mathbb{R}^n$$ contain all of the training inputs, labels, and noise respectively.
...
## The necessity of over-parameterization
