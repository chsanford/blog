...
The results require _isoperimetry_ to hold, which is true of a random variable $$x \in \mathbb{R}^d$$ if $$f(x)$$ has subgaussian tails for every Lipschitz function $$f$$. 
