...
These papers --- which study over-parameterization in the one of the most simple domains possible --- will be the main focus of this survey.
	...
	* _Support Vector Machines:_
		...
		* **[MNSBHS20](https://arxiv.org/abs/2005.08054){:target="_blank"}. [[OPML#10]]({% post_url 2021-11-04-mnsbhs20 %}){:target="_blank"}.** Muthukumar, Narang, Subramanian, Belkin, Hsu, and Sahai. "Classification vs regression in overparameterized regimes: Does the loss function matter?" 2020.
		...
		* **[CL20](https://arxiv.org/abs/2004.12019){:target="_blank"}. [[OPML#9]]({% post_url 2021-10-28-cl20 %}){:target="_blank"}.** Chatterji, Long. "Finite-sample Analysis of Interpolating Linear Classifiers in the Overparameterized Regime." 2020.
