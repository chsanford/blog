...
In other words, this transform down-weights the components of the parameter vector that correspond to "low-impact" coordinates that will be small anyways.
